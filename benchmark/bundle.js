...
for(i=0, ii=jquery.length; i<ii; ++i) {
  jqueryCharCodeArray.push(jquery.charCodeAt(i))
}
...
intLexer = new Function('input', automaton.toString({functionDef: true, strategy: 'int'}))

// add tests
suite
.add('finite-automata (char)', function() {
...
.add('finite-automata (int)', function() {
  intLexer(jqueryCharCodeArray)
})
...
},{"../lib/fragment":5,"./js-keywords.json":2,"benchmark":10,"fs":11}],2:[function(require,module,exports){
module.exports=[
  "break"
, "case"
, "class"
...
},{"./machine":6,"./string2dfa":9}],6:[function(require,module,exports){
var StateMachine
  , minimize = require('./minimize')
  , dfa2lexer = require('./dfa2lexer')
  , otherLexers = {
      'int': require('./dfa2intLexer')
    }
...
StateMachine.prototype.toString = function toString (opts) {
  ...
  if(opts.strategy) {
    return otherLexers[opts.strategy](def)
  }

  return dfa2lexer(def)
}

module.exports = StateMachine

},{"./dfa2intLexer":3,"./dfa2lexer":4,"./minimize":7}],7:[function(require,module,exports){
...
},{"./nfa2dfa":8}],8:[function(require,module,exports){
...
},{"FWaASH":12}],11:[function(require,module,exports){
